...
const data = [
  ...
  // const artLooper = content.forEach((e) => {
  //   const artFile = 
  // })
  // data.forEach(art => {
  //   article.appendChild()
 ...
 const newItems = {
    title: 'Declan will hold the one ring to rule them all',
    date: 'Dec 2nd, 2020',
    firstParagraph:"Declan ipsum",
    secondParagraph:"Declan ipsum",
    thirdParagraph: "Declan ipsum",
  }
  const newArty = articleMaker(newItems);
  content.appendChild(newArty);
